...
import DriverInventoryDashboard from '../../Components/Inventory/DriverInventoryDashboard';
        ...
        <div className="dr-dashboard">
            ...
            <main className="dr-main">
                ...
                <div className="dr-content">
                    ...
                    {activeTab === 'inventory' && (
                        <div className="content-section glass-card" style={{ padding: '0', background: 'transparent', boxShadow: 'none' }}>
                            <DriverInventoryDashboard />
                        </div>
                    )}
